    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            with gr.Tab("retake"):
                ...
                def retake_process_func(json_data: dict, retake_variance, retake_seeds):
                    return text2music_process_func(
                        # almost usable as **json_data
                        ...
                        actual_seeds=", ".join(map(str, json_data["actual_seeds"])),
                        ...
                        oss_steps=json_data["oss_steps"],
                        guidance_scale_text=json_data.get("guidance_scale_text", 0.0),
                        guidance_scale_lyric=json_data.get("guidance_scale_lyric", 0.0),
        ...
        def json2output(json_data: dict):
            return (
                ...
                json_data["prompt"],
                json_data.get("negative_prompt", None),
                json_data["lyrics"],
